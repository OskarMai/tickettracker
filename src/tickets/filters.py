...
class TicketFilter(django_filters.FilterSet):
	...
	Assigned_Project = CharFilter(field_name="project__name", lookup_expr='icontains',label='project name')
	Submitter = CharFilter(field_name="submitter__user_name",lookup_expr='icontains',label='submitted by')
